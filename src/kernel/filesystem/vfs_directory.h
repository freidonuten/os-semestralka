...
protected:
	...
	void Add_Child(Fat_Dir_Entry entry);

public:
	VFS_Directory(std::shared_ptr<Fat_Directory_Factory> factory, std::shared_ptr<Fat_Directory> parent_directory, char file_name[12], std::uint16_t file_attributes);
